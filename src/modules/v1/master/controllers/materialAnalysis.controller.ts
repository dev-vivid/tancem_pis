...
import {
	getAllMaterialAnalysisUsecase,
	getIdMaterialAnalysisUsecase,
	createMaterialAnalysisUsecase,
	updateMaterialAnalysisUsecase,
	deleteMaterialAnalysisUsecase,
...
export const getIdMaterialAnalysis = async (
	req: Request,
	res: Response,
	next: NextFunction
) => {
	try {
		...
		const result = await getIdMaterialAnalysisUsecase(id, accessToken);
