...
import { materialAnalysisFilterQuerySchema, createMaterialAnalysisBodySchema, updateMaterialAnalysisBodySchema, updateMaterialAnalysisParamsSchema, deleteMaterialAnalysisParamsSchema, getMaterialAnalysisParamsSchema } 
from "../validations/materialAnalysis.schema";
import { getAllMaterialAnalysis, getIdMaterialAnalysis, createMaterialAnalysis, updateMaterialAnalysis, deleteMaterialAnalysis } from "../controllers/materialAnalysis.controller";
